#!/usr/bin/env python3
"""
Quick Test and Training Script (Windows Compatible)
...
def test_environment():
    ...
    if python_version >= (3, 8):
        ...
        print(f"Python 3.8+ required, found {python_version.major}.{python_version.minor} - FAILED")
        return False
    ...
    try:
        ...
        print("PyTorch not available - FAILED")
        return False
    ...
    try:
        ...
        print("NumPy not available - FAILED")
        return False
...
def load_data():
    ...
    if data_file.exists():
        ...
        print("Training data not found - FAILED")
        return None
...
def quick_training():
    ...
    test_prompts = ["Hello", "Habari", "Good"]
    
    for prompt in test_prompts:
        test_input = encode_text(prompt, max_len=10)
